...
| Reads Mapped to sgRNA | Total number of reads that contained vector sequence that had a read mapping to a sgRNA at the set mismatch rate of < insert mismatch rate>.|
