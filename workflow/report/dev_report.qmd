...
PCA was performed using the **CPM, normalized counts** at the *sgRNA level*.

![sgRNA Count PCA by Biological Group](plots/bioGroup_sgRNACount_PCA_plot.png)

<br/>

![sgRNA Count PCA by Batch](plots/batch_sgRNACount_PCA_plot.png)

### gene count PCA

This was done using **CPM, normalized counts** at the *gene level*. Several sgRNAs typically fall under one gene, so these are summed to collapse guides targeting the same gene.

![Gene Count PCA by Biological Group](plots/bioGroup_geneCount_PCA_plot.png)

<br/>

![Gene Count PCA by Batch](plots/batch_geneCount_PCA_plot.png)
